...
const float FIELD_X = 8991;               // Rules: Item A
...
const float BORDER_STRIP_WIDTH = 830;     // Rules: Item I

const float GOAL_Y = 1480;                // Rules: Goal inner width (Fig. 2)
const float GOAL_POST_WIDTH = 115;        // Rules: Post width (Fig. 2)
const float GOAL_X = 570;                 // Rules: Distance from endline to 
                                          // back of goal (Fig. 2)

const float GOAL_HEIGHT = 850;            // Rules: Height of the goal, to the
